...
export const fr: Record<string, string> = {
  ...
  'problem.heading': 'Le trajet des employ\u00e9s est cass\u00e9',
  'problem.subtitle':
    'Les entreprises avec des bureaux physiques font face \u00e0 cinq probl\u00e8mes co\u00fbteux chaque jour.',
  'problem.0.title': 'Embouteillages',
  'problem.0.description':
    'Les employ\u00e9s perdent des heures dans les bouchons. Moins de voitures sur la route signifie des trajets plus courts pour tous.',
  'problem.0.solution': 'Moins de voitures = trajets plus courts',
  'problem.1.title': 'Co\u00fbts de stationnement',
  'problem.1.description':
    'Les entreprises d\u00e9pensent 2\u00a0400\u00a0\u00e0\u00a06\u00a0000\u00a0$ par place de parking par an \u2014 un gouffre budg\u00e9taire cach\u00e9.',
  'problem.1.solution': 'R\u00e9duire la demande de parking de 30\u00a0\u00e0\u00a040\u00a0%',
  'problem.2.title': 'Conformit\u00e9 ESG / Scope 3',
  'problem.2.description':
    'Les trajets des employ\u00e9s (Cat\u00e9gorie 7) sont difficiles \u00e0 mesurer et encore plus \u00e0 r\u00e9duire.',
  'problem.2.solution': 'Rapports automatis\u00e9s des \u00e9missions Cat\u00e9gorie 7',
  'problem.3.title': 'Coh\u00e9sion d\u2019\u00e9quipe',
  'problem.3.description':
    'Le t\u00e9l\u00e9travail et le travail hybride ont \u00e9rod\u00e9 les liens organiques entre coll\u00e8gues.',
  'problem.3.solution': 'Des liens naturels pendant les trajets partag\u00e9s',
  'problem.4.title': 'S\u00e9curit\u00e9 lors d\u2019\u00e9v\u00e9nements',
  'problem.4.description':
    'Les \u00e9v\u00e9nements d\u2019entreprise cr\u00e9ent un risque lorsque les employ\u00e9s conduisent apr\u00e8s avoir consomm\u00e9 de l\u2019alcool.',
  'problem.4.solution': 'Coordination de conducteurs d\u00e9sign\u00e9s int\u00e9gr\u00e9e',
  ...
  'steps.heading': 'De l\u2019inscription au covoiturage en quelques minutes',
  'steps.0.title': 'Inscription',
  'steps.0.description':
    'Connectez-vous avec le SSO de votre entreprise. Votre profil est cr\u00e9\u00e9 en quelques secondes.',
  'steps.1.title': 'D\u00e9finir votre zone',
  'steps.1.description':
    'Choisissez votre zone d\u2019habitation \u2014 une zone approximative respectueuse de votre vie priv\u00e9e.',
  'steps.2.title': 'Pr\u00e9f\u00e9rences',
  'steps.2.description':
    'Choisissez vos jours de trajet, cr\u00e9neaux horaires et si vous conduisez, \u00eates passager, ou les deux.',
  'steps.3.title': 'Jumelage',
  'steps.3.description':
    'Notre algorithme vous associe chaque jour avec des coll\u00e8gues sur des trajets similaires.',
  'steps.4.title': 'Confirmer et partir',
  'steps.4.description':
  ...
  'trust.2.title': 'Architecture multi-locataire',
  'trust.2.description':
    'Les donn\u00e9es de chaque entreprise sont totalement isol\u00e9es. Vos informations employ\u00e9s, historiques et analyses ne sont jamais partag\u00e9es.',
  ...
  'privacy.sharing.heading': 'Partage de donn\u00e9es et multi-locataire',
  'privacy.sharing.text':
    'Vos donn\u00e9es sont enti\u00e8rement isol\u00e9es au sein du locataire de votre employeur. Nous ne partageons jamais les donn\u00e9es des employ\u00e9s entre locataires. Les covoitureurs ne peuvent voir que votre pr\u00e9nom et votre zone d\u2019habitation approximative. Les administrateurs de votre employeur n\u2019ont acc\u00e8s qu\u2019\u00e0 des statistiques agr\u00e9g\u00e9es et anonymis\u00e9es.',
  'privacy.retention.heading': 'Conservation des donn\u00e9es',
  'privacy.retention.text':
    'Nous conservons vos donn\u00e9es pendant la dur\u00e9e de l\u2019abonnement de votre employeur. \u00c0 la r\u00e9siliation de l\u2019abonnement ou \u00e0 votre demande, vos donn\u00e9es personnelles seront supprim\u00e9es dans un d\u00e9lai de 30 jours.',
